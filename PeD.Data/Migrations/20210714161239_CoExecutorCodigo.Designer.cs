...
namespace PeD.Data.Migrations
{
    ...
    [Migration("20210714161239_CoExecutorCodigo")]
    partial class CoExecutorCodigo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeD.Core.Models.Captacoes.Captacao", b =>
                {
                    ...
                    b.Property<int?>("ArquivoComprobatorioId")
                        .HasColumnType("int");

                    b.Property<int?>("ArquivoFormalizacaoId")
                        .HasColumnType("int");

                    b.Property<int?>("ArquivoRiscosId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PropostaSelecionadaId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UsuarioExecucaoId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("UsuarioRefinamentoId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ArquivoComprobatorioId");

                    b.HasIndex("ArquivoFormalizacaoId");

                    b.HasIndex("ArquivoRiscosId");
                    ...
                    b.HasIndex("UsuarioExecucaoId");

                    b.HasIndex("UsuarioRefinamentoId");
            ...
            modelBuilder.Entity("PeD.Core.Models.Projetos.Escopo", b =>
                {
                    ...
                    b.ToTable("ProjetoEscopos");
                });

            modelBuilder.Entity("PeD.Core.Models.Projetos.Etapa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProjetoEtapas");
                });

            modelBuilder.Entity("PeD.Core.Models.Projetos.EtapaProdutos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProjetoEtapasProdutos");
                });

            modelBuilder.Entity("PeD.Core.Models.Projetos.Meta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProjetoMetas");
                });

            modelBuilder.Entity("PeD.Core.Models.Projetos.PlanoTrabalho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProjetoPlanosTrabalhos");
                });

            modelBuilder.Entity("PeD.Core.Models.Projetos.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProjetoProdutos");
                });

            modelBuilder.Entity("PeD.Core.Models.Projetos.Projeto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PeD.Core.Models.Propostas.ContratoComentario", b =>
                {
                    ...
                    b.ToTable("ContratoComentarios");
                });

            modelBuilder.Entity("PeD.Core.Models.Propostas.ContratoComentarioFile", b =>
                {
            ...
            modelBuilder.Entity("PeD.Core.Models.Propostas.PlanoComentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PlanoComentarios");
                });

            modelBuilder.Entity("PeD.Core.Models.Propostas.PlanoComentarioFile", b =>
                {
                    b.Property<int>("ComentarioId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeD.Core.Models.Propostas.Proposta", b =>
                {
                    ...
                    b.Property<int>("ContratoAprovacao")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PlanoTrabalhoAprovacao")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeD.Core.Models.Projetos.RegistroFinanceiroRh", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("RegistroFinanceiroRh");
                });

            modelBuilder.Entity("PeD.Core.Models.Projetos.RegistroFinanceiroRm", b =>
                {
                    b.HasBaseType("PeD.Core.Models.Projetos.RegistroFinanceiro");
                    ...
                    b.Property<bool>("EquipaLaboratorioNovo")
                        .HasColumnType("bit");

                    b.Property<string>("EspecificaoTecnica")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FuncaoEtapa")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsNacional")
                        .HasColumnType("bit");
                    ...
                    b.HasDiscriminator().HasValue("RegistroFinanceiroRm");
                });
            ...
            modelBuilder.Entity("PeD.Core.Models.Captacoes.Captacao", b =>
                {
                    b.HasOne("PeD.Core.Models.FileUpload", "ArquivoComprobatorio")
                        .WithMany()
                        .HasForeignKey("ArquivoComprobatorioId");

                    b.HasOne("PeD.Core.Models.FileUpload", "ArquivoFormalizacao")
                        .WithMany()
                        .HasForeignKey("ArquivoFormalizacaoId");

                    b.HasOne("PeD.Core.Models.FileUpload", "ArquivoRiscos")
                        .WithMany()
                        .HasForeignKey("ArquivoRiscosId");
                    ...
                    b.HasOne("PeD.Core.Models.ApplicationUser", "UsuarioAprovacao")
                        .WithMany()
                        .HasForeignKey("UsuarioAprovacaoId");

                    b.HasOne("PeD.Core.Models.ApplicationUser", "UsuarioExecucao")
                        .WithMany()
                        .HasForeignKey("UsuarioExecucaoId");

                    b.HasOne("PeD.Core.Models.ApplicationUser", "UsuarioRefinamento")
                        .WithMany()
                        .HasForeignKey("UsuarioRefinamentoId");
            ...
            modelBuilder.Entity("PeD.Core.Models.Projetos.Escopo", b =>
                {
                    b.HasOne("PeD.Core.Models.Projetos.Projeto", "Projeto")
                        .WithOne("Escopo")
                        .HasForeignKey("PeD.Core.Models.Projetos.Escopo", "ProjetoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PeD.Core.Models.Projetos.Etapa", b =>
                {
                    b.HasOne("PeD.Core.Models.Projetos.Produto", "Produto")
                        .WithMany()
            ...
            modelBuilder.Entity("PeD.Core.Models.Projetos.PlanoTrabalho", b =>
                {
                    b.HasOne("PeD.Core.Models.Projetos.Projeto", "Projeto")
                        ...
                        .HasForeignKey("PeD.Core.Models.Projetos.PlanoTrabalho", "ProjetoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PeD.Core.Models.Projetos.Projeto", b =>
                {
                    ...
                    b.HasOne("PeD.Core.Models.Propostas.Proposta", "Proposta")
                        .WithOne()
                        .HasForeignKey("PeD.Core.Models.Projetos.Projeto", "PropostaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("PeD.Core.Models.Propostas.ContratoComentarioFile", b =>
                {
                    b.HasOne("PeD.Core.Models.Propostas.ContratoComentario", "Comentario")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("PeD.Core.Models.Propostas.PlanoComentario", b =>
                {
                    ...
                    b.HasOne("PeD.Core.Models.Propostas.Proposta", "Proposta")
                        .WithMany("PlanoTrabalhoComentarios")
                        .HasForeignKey("PropostaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PeD.Core.Models.Propostas.PlanoComentarioFile", b =>
                {
                    b.HasOne("PeD.Core.Models.Propostas.PlanoComentario", "Comentario")
                        .WithMany("Files")
                        .HasForeignKey("ComentarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
